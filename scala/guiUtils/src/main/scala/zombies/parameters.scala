...
object parameters {
  ...
  val walkNoise = Range("walkNoise", RangeValue(0.0, 100.0, 0.1, physic.walkNoise, 0.0), Variable)
  val runNoise = Range("runNoise", RangeValue(0.0, 100.0, 0.1, physic.runNoise, 0.0), Variable)
  val exhaustNoise = Range("exhaustNoise", RangeValue(0.0, 100.0, 0.1, physic.exhaustNoise, 0.0), Variable)
  val fightNoise = Range("fightNoise", RangeValue(0.0, 100.0, 0.1, physic.fightNoise, 0.0), Variable)
